...
var app = {
	...
	var inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
        inAppBrowserbRef = cordova.InAppBrowser.open('https://www.facebook.com/Shaw7ha/', '_self', 'location=no,toolbar=no,zoom=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: 'ca-app-pub-7251676025279948/5670107193',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-7251676025279948/1926782230'	//PUT ADMOB ADCODE HERE 
                }
            };
